...
const driver = {
  ...
  profilerFormatterFunction: 'formatProfilerEntry@dbgate-plugin-mongo-v2',
  profilerTimestampFunction: 'extractProfileTimestamp@dbgate-plugin-mongo-v2',
  profilerChartAggregateFunction: 'aggregateProfileChartEntry@dbgate-plugin-mongo-v2',
